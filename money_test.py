...
class MoneyTest(unittest.TestCase):
    ...
    def test_simple_addition(self):
        self.assertTrue(Money.dollar(5) + Money.dollar(5) == Money.dollar(10))
    ...
    def test_simple_multiplication(self):
        self.assertTrue(Money.franc(10) * 2 == Money.franc(10))

    def test_multiplication_of_sum(self):
        self.assertTrue(Bank().reduce((Money.franc(5) + Money.franc(5)) * 3) == Money.franc(30))